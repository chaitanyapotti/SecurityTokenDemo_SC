...
module.exports = async callback => {
  ...
  await KNCInstance.approve(NetworkProxy.address, web3.utils.toWei(new BN(1000000)), { from: userWallet });
  await MANAInstance.approve(NetworkProxy.address, web3.utils.toWei(new BN(1000000)), { from: userWallet });
